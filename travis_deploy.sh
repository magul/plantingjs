...
openssl aes-256-cbc -K $encrypted_7a9f37839964_key -iv $encrypted_7a9f37839964_iv -in github_deploy_key.enc -out github_deploy_key -dchmod 600 github_deploy_key
eval `ssh-agent -s`
